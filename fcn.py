...
class FCN:
    ...
    def build(self,rgb, train=False,num_classes=4,random_init_fc8=False,debug=False):
        """
        ...
        if train:
            self.fc6 = tf.nn.dropout(self.fc7,0.5)
    ...
    def _max_pool(self,bottom,name,debug):
        pool = tf.nn.max_pool(bottom,ksize=[1,2,2,1],stride=[1,2,2,1],
    ...
    def _summary_reshape(self, fweight, shape, num_new):
        """
            ...
            onsider reordering fweight, to perserve semantic meaning of the
            weights.
...
def _activation_summary(x):
    """
        ...
        Creates a summary that provides a histogram of actiavtions.
